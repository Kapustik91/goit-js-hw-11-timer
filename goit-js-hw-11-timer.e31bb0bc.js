  ...
  _createClass(CountdownTimer, [{
    ...
    value: function countTimer() {
      ...
      this.intervalId = setInterval(function () {
        ...
        var countTime = _this.targetDate - todayDate;

        var time = _this.getTimeComponents(countTime);
...
function updateClockface(_ref2) {
  ...
  return "".concat(days, ":").concat(hours, ":").concat(mins, ":").concat(secs);
}
/*
